...
win.maxsize(500,500)
win.title("TETRIS")
win.config(bg="black" ,padx=20 ,pady=30)
...
Tetris_Image.pack()
space1=Label(bg="black")
space1.pack()
Enter_The_Game.pack()
space2=Label(bg="black")
space2.pack()
